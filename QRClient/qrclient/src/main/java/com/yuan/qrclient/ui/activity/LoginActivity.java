 ...
 */
public class LoginActivity extends BaseTitleActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mUsernamelView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        String email = mUsernamelView.getText().toString();
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        mUsernamelView.setAdapter(adapter);
    }
