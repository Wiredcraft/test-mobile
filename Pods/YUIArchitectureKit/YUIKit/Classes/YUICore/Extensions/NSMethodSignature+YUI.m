...
@implementation NSMethodSignature (YUI)

+ (NSMethodSignature *)yui_avoidExceptionSignature {
...
- (const char *)yui_typeEncoding {
    return self.yui_typeString.UTF8String;
}
