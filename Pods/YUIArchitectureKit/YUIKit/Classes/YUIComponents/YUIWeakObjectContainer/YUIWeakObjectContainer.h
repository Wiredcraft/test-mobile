...
//
//  YUIWeakObjectContainer.h
//  YUIKit
//
//  Created by YUI Team on 2018/7/24.
//
...
/**
 ...
 这时你可以将对象A包装为一个 YUIWeakObjectContainer，并改为通过强引用方式（OBJC_ASSOCIATION_RETAIN_NONATOMIC/OBJC_ASSOCIATION_RETAIN）绑定这个 YUIWeakObjectContainer，进而安全地获取原始对象A。
 */
@interface YUIWeakObjectContainer : NSProxy

/// 将一个 object 包装到一个 YUIWeakObjectContainer 里
