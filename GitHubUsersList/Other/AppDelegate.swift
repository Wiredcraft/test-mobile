...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, willFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        if #available(iOS 13, *) {
            ...
            //            let plistPath = Bundle.main.path(forResource: kModulesRegisterFileName, ofType: "plist")!
            //
            //            let mediator = AppLifeCycleMediator.sharedInstance()
            //            mediator.loadModules(withPlistFilePath: plistPath)
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
         ...
         */
        let container = NSPersistentCloudKitContainer(name: "YUIAll")
